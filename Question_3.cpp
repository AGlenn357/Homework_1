...
Andrew Glenn
Homework 1
Question 3: determining the roll rate of an aircraft with non-constant gain controller
*/
...
int main() {
    ...
    double K = -1.27; //gain value in controller at time t
    double alpha = -0.08; //adaptive rate value for controller
    ...
    for (int i = 1; i <= 500; i++) { //loop from t = 0 to t = 5
        ...
        K = K + alpha*Pt*Pt; //new gain K value based on current roll rate
